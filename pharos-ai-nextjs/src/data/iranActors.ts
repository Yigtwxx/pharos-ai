...
export const ACTORS: Actor[] = [
  ...
  },
  {
    id: 'hezbollah',
    name: 'Hezbollah',
    fullName: 'Hezbollah — Islamic Resistance in Lebanon',
    countryCode: 'lb',
    type: 'NON-STATE',
    activityLevel: 'HIGH',
    activityScore: 68,
    stance: 'PROXY',
    saying: '"The Islamic Resistance in Lebanon stands in full solidarity with the Islamic Republic of Iran and the Palestinian people. The Zionist enemy will pay the price on all fronts." — Hezbollah Secretary-General Naim Qassem, March 1, 2026',
    doing: [
      'Opened northern front against Israel — 340+ rockets and missiles fired at Haifa, Kiryat Shmona, Galilee (March 1 03:47 UTC)',
      'Baalbek command complex and Dahieh Beirut infrastructure struck by IDF Operation Northern Shield',
      'Long-range precision missile arsenal (~2,000 missiles in hardened tunnels) remains intact — not yet deployed',
      'Coordinating with IRGC remnant command on escalation thresholds and timing',
      'Attempting second barrage against Haifa — partially intercepted',
    ],
    assessment: 'Hezbollah\'s opening barrage on March 1 represented a measured entry into the conflict — using its conventional rocket layer (Katyushas, Falaq-2s) while holding back its 2,000 long-range precision missiles (Fateh-110, Zelzal, converted Syrian M-600). This distinction is critical: the surface barrage killed 4 civilians and was substantially intercepted. A decision to deploy the LRPM arsenal would overwhelm Israeli air defenses and likely trigger a full IDF ground invasion of Lebanon. Naim Qassem — the former deputy who replaced Hassan Nasrallah after his 2024 assassination — lacks Nasrallah\'s strategic authority and may be more risk-tolerant. IRGC coordination is ongoing but the death of IRGC Quds Force commander leaves Hezbollah\'s direct Iran command link weakened. Key uncertainty: will Hezbollah receive a direct order to fully escalate, or will it maintain threshold operations?',
    recentActions: [
      { date: '2026-03-01', type: 'MILITARY',  description: '340+ rockets and missiles fired at Haifa, Kiryat Shmona, Tiberias — 4 Israeli civilians killed', verified: true,  significance: 'HIGH' },
      { date: '2026-03-01', type: 'MILITARY',  description: 'Second barrage launched against Haifa — partially intercepted by Iron Dome',                    verified: true,  significance: 'HIGH' },
      { date: '2026-03-01', type: 'POLITICAL', description: 'Naim Qassem issued statement declaring solidarity with Iran and entry into conflict',            verified: true,  significance: 'HIGH' },
      { date: '2026-03-01', type: 'MILITARY',  description: 'Hezbollah long-range precision missile arsenal (~2,000) held in reserve — not deployed',         verified: true,  significance: 'HIGH' },
    ],
    keyFigures: ['Secretary-General Naim Qassem', 'Military Wing Commander (identity undisclosed)', 'Hezbollah Shura Council'],
    linkedEventIds: ['evt-014'],
  },
  {
    id: 'pmf',
    name: 'Iraqi PMF',
    fullName: 'Popular Mobilization Forces / Kata\'ib Hezbollah — Iraq',
    countryCode: 'iq',
    type: 'NON-STATE',
    activityLevel: 'ELEVATED',
    activityScore: 55,
    stance: 'PROXY',
    saying: '"The Islamic Resistance in Iraq confirms military operations against the American occupation forces. All American bases in Iraq are legitimate military targets in response to the criminal aggression against Iran." — Kata\'ib Hezbollah spokesperson, March 1, 2026',
    doing: [
      'Rocket and mortar barrage on Ayn al-Asad Air Base, Iraq — 2 US service members killed, 8 wounded (March 1)',
      'PMF launch positions used as transit corridor for IRGC Shahed drones targeting Israel',
      'PMF staging weapons and launch equipment at positions near Jurf al-Sakhar and Abu Ghraib',
      'US retaliatory strikes destroyed Kata\'ib Hezbollah primary weapons depot and command node',
    ],
    assessment: 'The Iraqi PMF — specifically Kata\'ib Hezbollah, the most IRGC-integrated PMF faction — represents a significant US vulnerability in Iraq. The Ayn al-Asad attack demonstrates that Iranian proxies have pre-planned targeting packages for all major US bases in Iraq, just as the IRGC did for Gulf bases. The use of Iraqi territory for transit of drones targeting Israel is a particularly dangerous escalation — it risks drawing Iraq formally into the conflict and complicates the Iraqi government\'s delicate balancing act. US retaliatory strikes on PMF depots near Baghdad put the Iraqi government in an impossible position. Iraqi PM al-Sudani is calling for US restraint while privately requesting IRGC Quds intermediaries to de-escalate.',
    recentActions: [
      { date: '2026-03-01', type: 'MILITARY',   description: 'Mortar and rocket attack on Ayn al-Asad Air Base — 2 US KIA, 8 WIA',          verified: true,  significance: 'HIGH'   },
      { date: '2026-03-01', type: 'MILITARY',   description: 'PMF positions used as Shahed drone launch corridor against Israel',           verified: false, significance: 'HIGH'   },
      { date: '2026-03-01', type: 'POLITICAL',  description: 'Iraqi PM al-Sudani protested US retaliatory strikes as violation of sovereignty', verified: true,  significance: 'MEDIUM' },
      { date: '2026-03-01', type: 'MILITARY',   description: 'US struck Kata\'ib Hezbollah depot Jurf al-Sakhar and Abu Ghraib command node', verified: true,  significance: 'HIGH'   },
    ],
    keyFigures: ['Kata\'ib Hezbollah leadership (undisclosed)', 'Abu Hussain al-Hamidawi (KH SG)', 'Iraqi PM Mohammed Shia\' al-Sudani (government)'],
    linkedEventIds: ['evt-019', 'evt-025'],
  },
];
