...
/**
 * Inline detail panel for mobile — renders inside the bottom sheet, no absolute positioning.
 */
export function MobileDetailPanel({ item, onClose, onSelectItem, onActivateStory }: Props) {
  return (
    <div style={{
