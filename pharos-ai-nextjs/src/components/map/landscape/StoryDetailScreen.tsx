      ...
      <LandscapeHeader
        ...
        right={
          <button
            ...
            className="flex items-center gap-1.5 px-2 py-1 border border-[var(--blue)] bg-[var(--blue-dim)] text-[var(--blue-l)] hover:bg-[var(--blue)] hover:text-white transition-colors"
          >
